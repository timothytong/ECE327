...
# add_input_file [list [concat {  } { fir_synth_pkg.vhd fir_lib.vhd fir.vhd fir_top.vhd }] ]
foreach file [concat {  } { fir_synth_pkg.vhd fir_lib.vhd fir.vhd fir_top.vhd }] {
  add_input_file $file
}  

compile

auto_write uw_tmp/fir_top_gate.vhd
...
auto_write uw_tmp/fir_top_logic.vhd
...
auto_write uw_tmp/fir_top_logic.v
