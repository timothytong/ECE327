...
# xsys( "vcom -93 +acc -work work-msim  fir.vhd fir_tb.vhd")
xsys( "uw-msim-com  fir.vhd fir_tb.vhd")

#------------------------------------------------------------------------
# run simulation

xsys( "vsim -lib work-msim     -wlf uw_tmp/vsim.wlf -t 1ns -do uw_tmp/uw-sim.tcl fir_tb(main)")
